...
/**
 * Resize an image to the specified dimension while maintaining aspect ratio.
 *
 * @param {Number} size
 * @return this
 */

Converter.prototype.resize = function (size) {
    this.operation.width = size;
    this.operation.height = size;
    this.operation.crop_width = false;
    return this;
};
...
utils.concurrent(Converter, 'size', 3);
utils.floodProtection(Converter, 'size');
utils.concurrent(Converter, 'save', 3);
utils.floodProtection(Converter, 'save');
